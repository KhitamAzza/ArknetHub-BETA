...
const faceScanScreen = document.getElementById("faceScanScreen");
...
function doLogout() {
  ...
  closeSearch();
  if (faceScanScreen) faceScanScreen.style.display = "none";
  if (typeof stopFaceScan === "function") stopFaceScan();
...
function showFaceID() {
  currentMode = 'FACE';
  absenMenuScreen.style.display = "none";
  if (faceScanScreen) faceScanScreen.style.display = "flex";
  initFaceScan();
}
